 ...
 * example file, the filename is "whmcs_rdns" and therefore all functions
 * begin "whmcs_rdns_".
 *
...
use WHMCS\Module\Addon\whmcs_rdns\Admin\AdminDispatcher;
use WHMCS\Module\Addon\whmcs_rdns\Client\ClientDispatcher;
 ...
 * @return array
 */
function whmcs_rdns_config()
{
    return [
        // Display name for your module
        'name' => 'WHMCS RDNS',
        // Description displayed within the admin interface
        'description' => 'WHMCS RDNS.',
        // Module author name
        'author' => 'Bubnov',
        // Default language
        'language' => 'english',
...
//            );
        ...
        return [
            // Supported values here include: success, error or info
            'status' => "error",
            'description' => 'Unable : ' . $e->getMessage(),
        ];
    }
}
 ...
 * @return array Optional success/failure message
 */
function whmcs_rdns_deactivate()
{
 ...
 * This function is optional.
 *
 * @see whmcs_rdns\Admin\Controller::index()
 *
 * @return string
 */
function whmcs_rdns_output($vars)
{
 ...
 * @return string
 */
function whmcs_rdns_sidebar($vars)
{
    // Get common module parameters
 ...
 * This function is optional.
 *
 * @see whmcs_rdns\Client\Controller::index()
 *
 * @return array
 */
function whmcs_rdns_clientarea($vars)
{
    // Get common module parameters
    $modulelink = $vars['modulelink']; // eg. index.php?m=whmcs_rdns
    $version = $vars['version']; // eg. 1.0
    $_lang = $vars['_lang']; // an array of the currently loaded language variables
